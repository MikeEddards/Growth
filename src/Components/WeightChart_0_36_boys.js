...
class WeightChart_0_36_boys extends Component {
    constructor(){
        super()
        this.state ={
            heightBirth: [],
        ...
        .then(res => { 
            let sort = this.state.heightBirth.map((num)=>{
                this.setState({
                    ...
                    p3: [...this.state.p3, +num.p3 * 2.205],
                    p5: [...this.state.p5, +num.p5  * 2.205],
                    p10: [...this.state.p10, +num.p10  * 2.205],
                    p25: [...this.state.p25, +num.p25  * 2.205],
                    p50: [...this.state.p50, +num.p50  * 2.205],
                    p75: [...this.state.p75, +num.p75  * 2.205],
                    p90: [...this.state.p90, +num.p90  * 2.205],
                    p95: [...this.state.p95, +num.p95  * 2.205],
                    p97: [...this.state.p97, +num.p97  * 2.205]
                   })
            })
        })
        .then(res => {
    ...
    render() {
       ...
       const data = {
        ...
        <h1>Weight chart for boys 0-36 months</h1>
...
export default WeightChart_0_36_boys