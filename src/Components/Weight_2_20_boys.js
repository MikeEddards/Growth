...
class Weight_2_20_boys extends Component {
    constructor(){
        super()
        this.state ={
            heightBirth: [],
                ...
                },
           {
            ...
            .then(res => {
                let finder = res.data.map(child => {
                    ...
                    if((find.length === 0 && child.age >= 2)&&(find.length === 0 && child.sex === 'male')){
                    ...
                    else if((find.length !== 0 && child.age >= 2)&&(find.length !== 0 && child.sex === 'male')){
...
export default Weight_2_20_boys